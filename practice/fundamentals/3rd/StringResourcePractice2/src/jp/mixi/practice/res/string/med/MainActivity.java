...
public class MainActivity extends Activity implements TextWatcher {
    ...
    public void onTextChanged(CharSequence s, int start, int before, int count) {
        ...
        String text_counter = getString(R.string.text_counter, count, TEXT_MAX_LENGTH);
        countView.setText(text_counter);
    }
    ...
    public void onConfirmClick(View v) {
        ...
        String toast_message = getString(R.string.toast_message, name, mClickCount);
